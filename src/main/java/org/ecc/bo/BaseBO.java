...
import org.ecc.exceptions.BusinessException;
import org.ecc.exceptions.GenericException;
import org.ecc.exceptions.InvalidRequestException;
import org.ecc.repository.BaseRepository;
import org.ecc.utils.PredicateUtils;
import org.ecc.utils.ConvertUtils;
...
import static org.ecc.constants.Constants.MSG_OBJ_DUPLICADO;
import static org.ecc.constants.Constants.TITLE_GENERIC;
import static org.ecc.constants.Constants.ZONE_ID;
    ...
    public ID manterObject(T object) throws Exception {
        try{
            ...
            if(Objects.isNull(id)){
                Map<String, Object> newObject = ConvertUtils.convertObjectToMap(object);
